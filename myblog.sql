...
--
-- Хост: localhost
-- Время создания: Мар 22 2018 г., 18:49
...
CREATE TABLE `users` (
  ...
  `type_user` enum('User','Administrator') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `users` (`id`, `username`, `email`, `password`, `type_user`) VALUES
(2, 'admin', 'test123@mail.ru', '$2y$10$lR9zGIRyhBVY7IK/.o7iH.e//0Q3h0Y9UxOeQahEdzaH6YLZjOUdy', 'Administrator');
